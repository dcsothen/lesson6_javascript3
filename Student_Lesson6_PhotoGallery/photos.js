...
function previewFive() {
    ...
    //create figure and img element for fifth image
...
function createEventListeners() {
    ...
    //the leftArrow() function will be executed when the user clicks the left navagation arrow button
        leftarrow.addEventListener("click",leftArrow, false);
        
    //declare variable for documetn element with id of rightarrow in the html document
        var rightarrow = document.getElementById("rightarrow");
    
    //add an event handler to the specfied document element (rightarrow)
    //the rightArrow() function will be executed when the user clicks the right navagation arrow
        rightarrow.addEventListener("click", rightArrow, false);
        
    //declare a variable for the element fiveButton
        var showAllButton = document.querySelector("#fiveButton p");
        
    //add event listern to showAllButton element
    //when user clicks the Show More button the prewviewFive fuction is executed
